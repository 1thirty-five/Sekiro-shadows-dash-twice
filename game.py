...
from scripts.utils import load_image,load_images1,Animation
...
class game:
    def __init__(self):
        ...
        self.assets = {
            ...
            'player/idle': Animation(load_images1('entities/player/idle'), img_dur=6),
            'player/run': Animation(load_images1('entities/player/run'), img_dur=4),
            'player/jump': Animation(load_images1('entities/player/jump')),
            ...
            'particle/particle': Animation(load_images1('particles/particle'), img_dur=6, loop=False),
            }
        ...
        self.player = Player(self, (50,50), (8,15))#player render 
